...
//indiamart
Route::get('/indiamartk/list','IndiaMartController@index')->name('indiamart_list');
...
//Category Routes
Route::post('add_category','CategoryController@index')->name('category_cre');
...
Route::get('add_category','MasterPropCategoryController@index')->name('propcategory');
Route::post('add_category/store','MasterPropCategoryController@store')->name('propcategories');
Route::get('/add_category/edit/{id}','MasterPropCategoryController@edit');
Route::post('/add_category/update/{id}','MasterPropCategoryController@update');
Route::get('/add_category/categoryactive/{id}','MasterPropCategoryController@categoryActive');
//Route::post('dynamic_dependent/fetch','Prop_PropertyController@fetch')->name('dynamicdependent.fetch');
                                                                            
Route::get('add_subcategory','MasterPropSubcategoryController@index')->name('propsubcategory');
Route::post('add_subcategory/store','MasterPropSubcategoryController@store')->name('sub_categories');
Route::get('/add_subcategory/edit/{id}','MasterPropSubcategoryController@edit');
Route::post('/add_subcategory/update/{id}','MasterPropSubcategoryController@update');
Route::get('/add_subcategory/subcategoryactive/{id}','MasterPropSubcategoryController@subcategoryactive');
...
Route::get('add_leadstatus','MasterLeadStatusController@index')->name('propleadstatus');
Route::post('add_leadstatus/store','MasterLeadStatusController@store')->name('sub_categories');
Route::get('/add_leadstatus/edit/{id}','MasterLeadStatusController@edit');
Route::post('/add_leadstatus/update/{id}','MasterLeadStatusController@update');
Route::get('/add_leadstatus/leadstatusactive/{id}','MasterLeadStatusController@leadstatusactive');

Route::get('add_leadsource','MasterLeadSourceController@index')->name('propleadsource');
Route::post('add_leadsource/store','MasterLeadSourceController@store')->name('lead_source');
Route::get('/add_leadsource/edit/{id}','MasterLeadSourceController@edit');
Route::post('/add_leadsource/update/{id}','MasterLeadSourceController@update');
Route::get('/add_leadsource/leadsourceactive/{id}','MasterLeadSourceController@leadsourceactive');

Route::get('add_leadreqtype','MasterLeadReqTypeController@index')->name('propleadreqtype');
Route::post('add_leadreqtype/store','MasterLeadReqTypeController@store')->name('lead_reqtype');
Route::get('/add_leadreqtype/edit/{id}','MasterLeadReqTypeController@edit');
Route::post('/add_leadreqtype/update/{id}','MasterLeadReqTypeController@update');
Route::get('/add_leadreqtype/leadsourceactive/{id}','MasterLeadReqTypeController@leadreqtypeeactive');

Route::get('add_propertytype','MasterPropertyTypeController@index')->name('propertytype');
Route::post('add_propertytype/store','MasterPropertyTypeController@store')->name('property_type');
Route::get('/add_propertytype/edit/{id}','MasterPropertyTypeController@edit');
Route::post('/add_propertytype/update/{id}','MasterPropertyTypeController@update');
Route::get('/add_propertytype/propertytypeactive/{id}','MasterPropertyTypeController@propertytypeactive');
...
Route::get('channelpartners','MasterPropCpController@index')->name('channelpartners');
Route::get('add_cp','MasterPropCpController@display')->name('add_cp');
Route::post('/channelpartners/store','MasterPropCpController@store');
Route::get('/channelpartners/cpactive/{id}','MasterPropCpController@cpActive');
Route::get('Update_cp/{id}/{image}','MasterPropCpController@updateForm');
Route::get('/channelpartners/edit/{id}','MasterPropCpController@edit');
Route::post('/channelpartners/update/{id}/{image}','MasterPropCpController@update');