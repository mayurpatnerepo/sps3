...
<div class="card" id="container_div">
    ...
    <h3 class="card-title text-center"><b>ADD/UPDATE PROPERTY CATEGORY</b></h3>
    </div>
      <div class="card-body">
                ...
                <center>
                    <form id="category_form">
                      ...
                      {{csrf_field()}}
                        ...
                        <div class="col-2">
                            <button class="form control btn btn-outline-success" type="button" title="Add Category" name="category_create" id="add_category" value="Create" onKeyPress="return ValidateAlpha(event);"> Create</button>
              ...
              <table class=" table nowrap data-table table-responsive display " style="width:100%" cellspacing="0"  id="data_table">
                ...
                <tr>
                  ...
                  <th>Is Active</th>
                    ...
                    <tbody class="tbody">
                        <?php $sr_no = 1 ?>
                        @foreach ($propcategories as $category)
                        <tr>
                          <td>{{$sr_no}}</td>
