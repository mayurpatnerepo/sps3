...
<div class="card bg-primary" id="container_div">
              <div class="card-header" id="headername">
                <h3 class="card-title text-center"><b>ADD PROPERTY</b></h3>
              </div> 
               </div>
              ...
              <div class="card-body">
                ...
                <br>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-3">
                            <label>Property Category</label>
                                <input list="propertycategory" name="property_category" id="property_category" placeholder="Select Category" class="form-control dynamic" data-dependent="property_type" >
                                  <datalist id="propertycategory">
                                  @foreach($prop_categories as $prop_category)
                                  <option  value="{{$prop_category[0]->property_category}}"></option> 
                                   @endforeach
                                  </datalist>
                    ...
                    <div class="col-3">
                      ...
                      <div class="col-3">
                              <label>Project Name</label>
                                  <select list="Project_Name Category" name="Project_Name" id="Project_Name" placeholder="Project Name" class="form-control noerror" >
                                <datalist id="Project_Name">
                                  @foreach($projects as $project)
                                  <option  value="{{$project->proj_project_name}}">{{$project->proj_project_name}}</option> 
                  ...
                  <p class="card-title"><font color="green"><b>PROPERTY PRICE/RENT PER MONTH</b></font></p>
                        <br>
                  ...
                  <p class="card-title"><font color="green"><b>OWNER LANDLORD INFORMATION</b></font></p>
                        <br>
                     ...
                     <div class="col-3">
                      ...
                      <div class="col-3">
                            ...
                            <div class="col-3">
                          <label>New Owner/Landloard Contact</label>
                ...
                <div class="form-group row">  
                    <div class="col-12" style="align-items: center;">
                        <label>Description/Note (Only 800 characters allow)</label>
