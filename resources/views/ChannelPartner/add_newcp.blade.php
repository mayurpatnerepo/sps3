...
<meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    <div class="card-header" id="headername" style="font-weight:solid">
    	<h3 class="card-title text-center"><b>ADD CHANNEL PARTNER</b></h3>
    </div>
	  <div class="card-body">
        <div class="cc_wrapper">
			...
			<div class="form-group  row justify-content-md-center  ">
			 ...
			 <input id="mydata" type="hidden" value=""/>
				<hr class="seperator">
				<p class="card-title"><font color="green"><b>CHANNEL PARTNER INFORMATION</b></font></p>
               <br>      
			
				<div class="form-group  row justify-content-md-center"><!--name-->
			  <label for="cp_id" class="col-2 col-form-label required">CP Id</label>
			  <div class="col-3">
				<input class="form-control noerror" type="text" placeholder="CP Id" name="cp_id" value="" id="cp_id">
			  </div>
			  <div class="col-3">
			  </div>
			  <div class="col-2">
			...
			<div class="form-group  row justify-content-md-center "><!--Email--><!--Alt Contact no-->
			  ...
			  <div class="col-md-3">
<input class="form-control noerror" type="text" placeholder="Channel Partner Contact" maxlength="15" onkeypress="return isNumber(event)" name="cp_contact" value="" id="cp_contact">			  </div>
			</div>
			...
			<div id="ICE_segment" class="ICE_segment">
				...
				<p class="card-title"><font color="green"><b>IN CASE OF EMERGENCY</b></font></p>
               <br>      
			</div>
			...
			<div class=" row justify-content-md-center ">
				<div class="col-2">
					<input type="submit" class="btn btn-success " name="staff_registration" id="staff_registration" value="Create Channel Partner" style="width:100%"/>
				</div><!--/* button_login */-->
				<div class="col-2"></div>
				<div class="col-2">
...
function ValidateAlpha(evt)
	...
	if(id=""){
		document.getElementById('cp_id').value="000"+ 1;
	}
	else if(id<9){
		id=document.getElementById('hidden').value;
		var second_id = parseInt(id);
		document.getElementById('cp_id').value="000"+(second_id+1);
	}
	else if(id>9 && id<99){
		id=document.getElementById('hidden').value;
		var second_id = parseInt(id);
		document.getElementById('cp_id').value="00"+(second_id+1);
	}
	else if(id>=99 && id<999){	
		id=document.getElementById('hidden').value;
		var second_id = parseInt(id);
		document.getElementById('cp_id').value="0"+(second_id+1);
	}
	else{
		id=document.getElementById('hidden').value;
		var second_id = parseInt(id);
		document.getElementById('cp_id').value=(second_id+1);
	}
...
function validate_form()
  {
    ...
    var cp_username = document.getElementById('cp_username').value;
    var cp_password = document.getElementById('cp_password').value;
    ...
    if(first_name==""){
        swal("Enter Channel Partner Name","","warning");
        return false;
    }else if(cp_username==""){
        swal("Enter Channel Partner Username","","warning");
        return false;
    }else if(cp_password==""){
        swal("Enter Channel Partner Password","","warning");
        return false;
    }else if(email_input==""){
        swal("Enter Channel Partner Email","","warning");
        return false;
    }else if(cp_contact==""){
        swal("Enter Channel Partner Contact Number","","warning");
        return false;
    }else if(gender==""){
        swal("Enter Channel Partner Gender","","warning");
        return false;
    }else if(dob==""){
        swal("Enter Channel Partner Date of Birth","","warning");
        return false;
    }else if(designation==""){
        swal("Enter Channel Partner Designation","","warning");
        return false;
    }
    ...
    $('#staff_registration').click(function (e) {
        ...
        if(test==true){
          ...
          success: function (data) {
              ...
              swal('Channel Partner Created Successfully',"","success");
