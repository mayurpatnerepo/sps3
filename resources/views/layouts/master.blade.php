...
<head>
  ...
  <link rel="icon" href="admin-lte/dist/img/Logo_Trans.png" type="image/x-icon">
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="home" class="brand-link">
          <img src="{{asset('admin-lte/dist/img/LOGO-SPS.png')}}" alt="AdminLTE Logo" class="  brand-image" style="opacity: .8; width: 50px; height:100%; margin-top: 10px; ">
          ...
          <nav class="mt-2">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{route('add_cp')}}" class="nav-link">
                      &nbsp;&nbsp; <i class="fas fa-plus-circle"></i>
                      <p>Create CP</p>
                    </a>
                  </li>
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{route('channelpartners')}}" class="nav-link">
                      &nbsp;&nbsp; <i class="fas fa-list"></i>
                      <p>List of CPs</p>
                    </a>
                  </li>
              ...
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="{{route('propcategory')}}" class="nav-link">
                          &nbsp;&nbsp;&nbsp;&nbsp; <i class="fas fa-plus-circle"></i>
                          <p>Category</p>
                        </a>
                      </li>
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="{{route('propertytype')}}" class="nav-link">
                          &nbsp;&nbsp;&nbsp;&nbsp; <i class="fas fa-plus-circle"></i>
                          <p>Sub-Category</p>
                        </a>
                      </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="{{route('propleadstatus')}}" class="nav-link">
                          &nbsp;&nbsp;&nbsp;&nbsp; <i class="fas fa-plus-circle"></i>
                          <p>Lead Status</p>
                        </a>
                      </li>
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="{{route('propleadsource')}}" class="nav-link">
                          &nbsp;&nbsp;&nbsp;&nbsp; <i class="fas fa-plus-circle"></i>
                          <p>Lead Source</p>
                        </a>
                      </li>
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="{{route('propleadreqtype')}}" class="nav-link">
                          &nbsp;&nbsp;&nbsp;&nbsp; <i class="fas fa-plus-circle"></i>
