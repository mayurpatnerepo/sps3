...
use App\PropFollowup; //followup
use App\PropCustomer; //client
use App\Lead; //enquiry
use App\Property; //enquiry_products
use Carbon\Carbon;


class PropFollowupController extends Controller
{
    /**
    ...
    {
        $prop_customers = PropCustomer::all(); 
       return view("Prop_Followup/create_prop_followup")->with('prop_customers',$prop_customers);
    }
 /**
     * Display a listing of the resource.
     *
    ...
    {
       $prop_followup=new PropFollowup;
       $prop_followup->rem_date=$request->rem_date;
       $prop_followup->rem_time=$request->rem_time;
       $prop_followup->subject=$request->subject;
       $prop_followup->note=$request->remark;
       $prop_followup->nature=$request->nature;
       $prop_followup->organization_name=$request->organization_name1;
       $prop_followup->Contact_Persone_Name=$request->Contact_Persone_Name;
       $prop_followup->organization_id=$request->hidden_orgid;
       $prop_followup->mobile=$request->mobile;
       $prop_followup->save();
